...
class Manzana(Fruta):
    ...
    def pelar(self):
        print(f"pelando la {self.nombre} bien pelada...") 
...
class Deporte:
    ...
    def comenzar_juego(self):
        print(f"empezando a jugar {self.nombre}")
        
class Baloncesto(Deporte):
    def __init__(self, nombre, numero_jugadores, altura_canasta):
        super().__init__(nombre, numero_jugadores)            
        self.altura_canasta = altura_canasta
    def Lanzar_pelota(self):
        print("lanzando la pelota ")
        
class Voleibol(Deporte):
    def __init__(self, nombre, numero_jugadores, altura_red):
        super().__init__(nombre, numero_jugadores)         
        self.altura_red = altura_red
    def servir(self):
        print("sirviendo la pelota para la clavada ")
        
lakers = Baloncesto("baloncesto", 5, "2 metros")
lakers.comenzar_juego()
lakers.Lanzar_pelota()
felinos = Voleibol("voleibol", 5, "1.80 metros")
